...
import com.shiyunjin.easycontrolpro.app.databinding.ActivityMainBinding;
import com.shiyunjin.easycontrolpro.app.entity.AppData;
import com.shiyunjin.easycontrolpro.app.entity.Device;
import com.shiyunjin.easycontrolpro.app.helper.DeviceListAdapter;
  ...
  protected void onActivityResult(int requestCode, int resultCode, Intent data) {
    if (resultCode == RESULT_OK && requestCode == 1) {
      ...
      try {
        ...
        String fileName = "easycontrolpro_push_file";
