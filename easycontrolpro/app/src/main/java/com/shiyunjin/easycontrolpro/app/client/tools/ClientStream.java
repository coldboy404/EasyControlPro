package com.shiyunjin.easycontrolpro.app.client.tools;
...
import com.shiyunjin.easycontrolpro.app.BuildConfig;
import com.shiyunjin.easycontrolpro.app.R;
import com.shiyunjin.easycontrolpro.app.adb.Adb;
import com.shiyunjin.easycontrolpro.app.buffer.BufferStream;
import com.shiyunjin.easycontrolpro.app.client.decode.DecodecTools;
import com.shiyunjin.easycontrolpro.app.entity.AppData;
import com.shiyunjin.easycontrolpro.app.entity.Device;
import com.shiyunjin.easycontrolpro.app.entity.MyInterface;
...
public class ClientStream {
  ...
  private static final String serverName = "/data/local/tmp/easycontrolpro_server_" + BuildConfig.VERSION_CODE + ".jar";
  ...
  private void startServer(Device device) throws Exception {
    if (BuildConfig.ENABLE_DEBUG_FEATURE || !adb.runAdbCmd("ls /data/local/tmp/easycontrolpro_*").contains(serverName)) {
      adb.runAdbCmd("rm /data/local/tmp/easycontrolpro_* ");
      adb.pushFile(AppData.applicationContext.getResources().openRawResource(R.raw.easycontrolpro_server), serverName, null);
    }
    shell = adb.getShell();
    shell.write(ByteBuffer.wrap(("app_process -Djava.class.path=" + serverName + " / com.shiyunjin.easycontrolpro.server.Server"
