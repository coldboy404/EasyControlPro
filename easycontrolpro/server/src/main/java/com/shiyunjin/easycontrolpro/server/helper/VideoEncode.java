 ...
 */
package com.shiyunjin.easycontrolpro.server.helper;
...
import com.shiyunjin.easycontrolpro.server.Server;
...
public final class VideoEncode {
  ...
  public static void startEncode() throws InvocationTargetException, NoSuchMethodException, IllegalAccessException, IOException, ErrnoException {
    ...
    // 创建显示器
    try {
      virtualDisplay = DisplayManager.createVirtualDisplay("easycontrolpro", Device.displayInfo.width, Device.displayInfo.height, Device.displayInfo.displayId, surface);
    } catch (Exception displayManagerException) {
      display = SurfaceControl.createDisplay("easycontrolpro", Build.VERSION.SDK_INT < Build.VERSION_CODES.R || (Build.VERSION.SDK_INT == Build.VERSION_CODES.R && !"S".equals(Build.VERSION.CODENAME)));
